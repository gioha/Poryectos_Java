...
@Embeddable
public class DTODistribucionTotalesPK implements Serializable {


	private static final long serialVersionUID = -2464592690898647104L;
	...
	public DTODistribucionTotalesPK(){
		
	}
	
	public DTODistribucionTotalesPK(Integer idProcesoElectoral, Integer idDetalleProceso, Integer idEstado,
