...
public class DTOConsejeroPK implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -2343302534942814278L;
	...
	@Column(name = "ID_CONSEJERO", nullable = false)
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "MY_SEQ_GEN_CON")
	@SequenceGenerator(name = "MY_SEQ_GEN_CON", sequenceName = "S_CONSEJEROS")
	private Integer idConsejero;
	...
	public Integer getIdConsejero() {
		return idConsejero;
	}

	public void setIdConsejero(Integer idConsejero) {
