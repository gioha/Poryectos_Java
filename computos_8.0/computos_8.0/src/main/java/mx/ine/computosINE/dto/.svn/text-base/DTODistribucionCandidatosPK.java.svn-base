...
@Embeddable
public class DTODistribucionCandidatosPK implements Serializable {

	private static final long serialVersionUID = -4028055404599075293L;
	...
	public DTODistribucionCandidatosPK(){
		
	}
	
	public DTODistribucionCandidatosPK(Integer idProcesoElectoral, Integer idDetalleProceso, Integer idEstado,
