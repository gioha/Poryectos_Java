...
/**
 * <code>BSDInformacionGeneralActaInterface.java</code>Descripcion de la clase
 *
 * @author Alejandra Gómez Ruiz
 * @version 1.0
 * @since 06/05/2017 13:46:00
 */
public interface BSDInformacionGeneralActaInterface {

	
	/**
	 * Recupera el numero de actas capturadas por el tipo de candidatura
	 * @param arg0
	 * @return
	 * @throws Exception
	 */
	...
	public List<Object[]> consultaActasCaptByMunDistrito(Integer idProceso, Integer idDetalleProceso,
	 ...
	 /**
	   * Obtiene la suma de votos por regiduria mr, para generar el acta de regidurias rp sin contemplar candidatos independientes
	   * @param arg0
	   * @return
	   */
