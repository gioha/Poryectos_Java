...
//    private Integer idDistritoSeleccionado;
     ...
     * Lista de distritos del estado seleccionado
     */
    private List<DTODetalleMunicipioProcesoWS> listaMunicipios;
    /**
     * Distrito seleccionado
     */
    private DTODetalleMunicipioProcesoWS municipioSeleccionado;
    /**
     * Id Distrito seleciconado del menu lateral
     */
    private Integer idMunicipioSeleccionado;
...
//	}
	 ...
	 *
	 * @return Date : valor que tiene el atributo idMunicipio
	 * 
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	 ...
	 *
	 * @param fechaAprobacionCasillaJunta : valor que ingresa a el atributo idMunicipio
	 *
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	 ...
	 *
	 * @return Date : valor que tiene el atributo nombreMunicipio
	 * 
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	 ...
	 *
	 * @param fechaAprobacionCasillaJunta : valor que ingresa a el atributo nombreMunicipio
	 *
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	...
	/**
	 * Método que obtiene el valor de el atributo municipioSeleccionado
	 *
	 * @return Date : valor que tiene el atributo municipioSeleccionado
	 * 
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	public DTODetalleMunicipioProcesoWS getMunicipioSeleccionado() {
		return municipioSeleccionado;
	}

	/**
	 * Método que ingresa el valor de el atributo municipioSeleccionado
	 *
	 * @param fechaAprobacionCasillaJunta : valor que ingresa a el atributo municipioSeleccionado
	 *
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	public void setMunicipioSeleccionado(
			DTODetalleMunicipioProcesoWS municipioSeleccionado) {
		this.municipioSeleccionado = municipioSeleccionado;
	}

	/**
	 * Método que obtiene el valor de el atributo idMunicipioSeleccionado
	 *
	 * @return Date : valor que tiene el atributo idMunicipioSeleccionado
	 * 
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	public Integer getIdMunicipioSeleccionado() {
		return idMunicipioSeleccionado;
	}

	/**
	 * Método que ingresa el valor de el atributo idMunicipioSeleccionado
	 *
	 * @param fechaAprobacionCasillaJunta : valor que ingresa a el atributo idMunicipioSeleccionado
	 *
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	public void setIdMunicipioSeleccionado(Integer idMunicipioSeleccionado) {
		this.idMunicipioSeleccionado = idMunicipioSeleccionado;
	}

	/**
	 * Método que obtiene el valor de el atributo listaMunicipios
	 *
	 * @return Date : valor que tiene el atributo listaMunicipios
	 * 
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	public List<DTODetalleMunicipioProcesoWS> getListaMunicipios() {
		return listaMunicipios;
	}

	/**
	 * Método que ingresa el valor de el atributo listaMunicipios
	 *
	 * @param fechaAprobacionCasillaJunta : valor que ingresa a el atributo listaMunicipios
	 *
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	public void setListaMunicipios(
			List<DTODetalleMunicipioProcesoWS> listaMunicipios) {
	...
	public String toString() {
		return "DTOUsuarioLogin [usuario=" + usuario + ", nombreUsuario="
				...
				+ nombreEstado + ", idMunicipio=" + idMunicipio
				+ ", nombreMunicipio=" + nombreMunicipio + ", ubicacion="
				...
				+ idDetalleProceso + ", listaMunicipios=" + listaMunicipios
				+ ", municipioSeleccionado=" + municipioSeleccionado
				+ ", idMunicipioSeleccionado=" + idMunicipioSeleccionado + "]";
	}
