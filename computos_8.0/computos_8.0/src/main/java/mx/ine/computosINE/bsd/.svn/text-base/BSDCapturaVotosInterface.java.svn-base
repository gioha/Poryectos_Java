...
/**
 * <code>BSDCapturaVotosInterface.java</code>Descripcion de la clase
 *
...
public interface BSDCapturaVotosInterface {

	/**
	 * Obtiene las actas capturadas por entidad
	 */
	...
	/**
	 * Obtiene una lista de casillas parciales capturadas en distrito
	 */
	public Integer getActasParcialesCapturadasEnDistrito(DTODistribucionCandParcialPK id) throws Exception;
	
	/**
	 * Obtiene una lista de casillas capturadas en entidad
	 * @param id
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * Obtiene una lista de casillas capturadas en distrito
	 * @param id
	 * @return
	 * @throws Exception
	 */
