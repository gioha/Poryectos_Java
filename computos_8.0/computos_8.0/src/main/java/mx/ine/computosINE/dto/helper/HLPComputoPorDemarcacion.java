...
public class HLPComputoPorDemarcacion implements Serializable {

	private static final long serialVersionUID = 260520171244L;
	...
	private static final int NUM_COLUMNAS_OMITIENDO_ASOCIACIONES = 2;
	...
	private boolean hayCasillasEspeciales;
	...
	public void iniciaReporte(DTOFiltroReportes filtros) {
		...
		obtenTituloReporte(filtros.getNombreDemarcacion());
	...
	private void obtenTituloReporte(String nombreDemarcacion) {
		String titulo = Utilidades
				.mensajeProperties("etiqueta_reporte_titulo_computoPorDemarcacion");
	...
	public boolean hayCasillasEspeciales() {
		return hayCasillasEspeciales;
	}

	public void setHayCasillasEspeciales(boolean hayCasillas) {
		this.hayCasillasEspeciales = hayCasillas;
	}
