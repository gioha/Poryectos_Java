...
@Embeddable
public class DTODistribucionCandParcialPK implements Serializable {

	
	private static final long serialVersionUID = -3229182761017918222L;
	...
	@Column(name = "ID_COALICION")
	private Integer idCoalicion;
	
	
	public DTODistribucionCandParcialPK(){
		
	}
	
	
	public DTODistribucionCandParcialPK(Integer idProcesoElectoral, Integer idDetalleProceso, Integer idEstado,
			Integer idDistrito, Integer idMunicipio, Integer idRegiduria, Integer seccion, Integer idComunidad,
			Integer idTipoCandidatura, Integer idAsociacion, Integer idCoalicion) {
		super();
