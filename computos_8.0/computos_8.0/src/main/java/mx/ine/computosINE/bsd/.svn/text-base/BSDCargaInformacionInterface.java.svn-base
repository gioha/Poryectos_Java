...
/**
 * <code>BSDCargaInformacionInterface.java</code>Descripcion de la clase
 *
 * @author Clemencia Cuellar
 * @version 1.0
 * @since 24/04/2017 11:20:00
 */
public interface BSDCargaInformacionInterface {

	/**
	 * Casillas aprobadas por consejo en una entidad
	 */
	...
	/**
	 * OBtiene los datos de una estado
	 * @param idEstado
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * Obtiene el detalle de un minicipio
	 * @param idEstado
	 * @param idMunicipio
	 * @param ambitoProceso
	 * @return
