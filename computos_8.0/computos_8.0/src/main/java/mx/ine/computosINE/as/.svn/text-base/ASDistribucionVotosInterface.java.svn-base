...
/**
 * <code>ASDistribucionVotosInterface.java</code>Descripcion de la clase
 *
 * @author Alejandra Gómez Ruiz
 * @version 1.0
 * @since 28/04/2017 11:58:00
 */
public interface ASDistribucionVotosInterface {
	...
	/**
	 * Devuelve las distribuciones de votos a partir de la lista de DTOActaCasillaVotos que conforman un acta
