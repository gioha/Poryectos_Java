...
import mx.ine.common.dao.impl.DAOGenericFuncionesComunesImpl;
import mx.ine.computosINE.dao.DAOGenericInterface;
 ...
 * @since  06/06/2016
 */
public class DAOGeneric <T extends Serializable, ID extends Serializable> extends DAOGenericFuncionesComunesImpl implements DAOGenericInterface<T, ID>{
