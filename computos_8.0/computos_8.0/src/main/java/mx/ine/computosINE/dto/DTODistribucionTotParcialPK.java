...
@Embeddable
public class DTODistribucionTotParcialPK implements Serializable {


	private static final long serialVersionUID = -4051563992572358607L;
	...
	public DTODistribucionTotParcialPK(){
		
	}
	
	public DTODistribucionTotParcialPK(Integer idProcesoElectoral, Integer idDetalleProceso, Integer idEstado,
