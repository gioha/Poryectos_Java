...
import mx.ine.computosINE.dto.helper.HLPAccionModulo;
...
public class FormAdministrador implements Serializable {
	...
	/**
	 * Método que obtiene el valor de el atributo disableMunicipio
	 *
	 * @return Date : valor que tiene el atributo disableMunicipio
	 * 
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
	...
	/**
	 * Método que ingresa el valor de el atributo disableMunicipio
	 *
	 * @param fechaAprobacionCasillaJunta : valor que ingresa a el atributo disableMunicipio
	 *
	 * @author Pablo Zuñiga Mata
	 * @since 18/04/2017
	 */
