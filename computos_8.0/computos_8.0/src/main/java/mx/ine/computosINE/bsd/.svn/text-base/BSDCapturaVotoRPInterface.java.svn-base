...
/**
 * <code>BSDCapturaVotoRPInterface.java</code>Descripcion de la clase
 *
 * @author Clemencia Cuellar
 * @version 1.0
 * @since 27/04/2017 11:27:00
 */
public interface BSDCapturaVotoRPInterface {
	...
	/**
	 * Consulta la informacion de los candidatos por acta
	 * @param id
	 * @param idEstatus
	 * @param modulo
	 * @return
