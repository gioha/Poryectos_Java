...
public class SecurityResponseHeadersFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		LOGGER.info("Inicializando el filtro de los encabezados de seguridad para la respuesta");
	}
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
		LOGGER.info("Agregando los encabezados de seguridad a la respuesta");
