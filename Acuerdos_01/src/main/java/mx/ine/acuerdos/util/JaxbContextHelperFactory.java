...
public class JaxbContextHelperFactory {
    ...
    public static JaxbUtil.JaxbContextHelper getJaxbContextHelper(Class<?>[] classesToBeBound) {
        return new AcuerdosJaxbContextHelper(classesToBeBound);
    }
     ...
     * @since 08/09/2016
     */
    private static class AcuerdosJaxbContextHelper implements JaxbUtil.JaxbContextHelper {
         ...
         * @since 19/10/2016
         */
        AcuerdosJaxbContextHelper(Class<?>[] classesToBeBound) {
