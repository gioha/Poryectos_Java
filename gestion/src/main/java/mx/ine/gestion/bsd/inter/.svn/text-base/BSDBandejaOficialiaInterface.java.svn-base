/**
 * @(#)BSDBandejaOficialiaInterface.java 17/08/2017
 *
 ...
 * @since 16/11/2017
 */
public interface BSDBandejaOficialiaInterface {
	...
	/**
	 * Método que consulta a la tabla DOCUMENTOS_ANEXOS los anexos de un documento
	 * 
	 * @return DTOBandejaEntradasOficialiaEntity: Objeto que consultará los anexos
	 * 
	 * @author David Rodríguez Corral
	 * @since 24/11/2017
	 */
