...
/**
 * Interface  que contiene la firma de los métodos que acceden a el o los AS de los Corresponsales del sistema de Gestión
 *
 * @author Luis Urrutia
 * @since 16/11/2017
 */
public interface BSDCapturaCorresponsalInterface {
