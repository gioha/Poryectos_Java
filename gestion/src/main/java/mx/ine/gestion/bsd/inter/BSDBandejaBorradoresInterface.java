...
/**
 * Interface que contiene la firma de los métodos del AS que serán ocupados en
 * el módulo de Bandeja del sistema de Gestión.
 * 
 ...
 * @since 26/04/2018
 */
public interface BSDBandejaBorradoresInterface {
	...
	/**
	 * Método que elimina el documento de la tabla "BORRADOR_DOCUMENTOS" y lo
	 * inserta en la tabla de "ENVIADOS_DOCUMENTOS"
	 * 
	 * @param documento
	 * @param persona
	 *
	...
	/**
	 * Método encargado de enviar el o los correos de notificación correspondientes al firmado de un documento.
	 * @author José Miguel Ortiz
	 * @param DTOEstructuraAreasEntity remitente, List<DTOEstructuraAreasEntity> destinatarios, DTOBorradorDocumentosEntity documento, String tipoEnvio
	 * @return void
	 * @since 26/04/2018
	 */
