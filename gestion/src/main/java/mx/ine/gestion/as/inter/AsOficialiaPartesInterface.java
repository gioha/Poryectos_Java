/**
 * @(#)AsOficialiaPartesInterface.java 02/11/2017
 *
...
/**
 * Interface de la clase AsOficialiaPartes, encargada de administrar los objetos
 * BO y DAO para el modulo de oficialia de partes ademas de generar funciones de
 * sistema relacionados a este.
 * 
 ...
 * @since 09/04/2018
 */
public interface AsOficialiaPartesInterface {
	/**
	...
	/**
	 * Método encargado de insertar en BD toda la información relacionada a la carga de un
	 * nuevo documento de oficialía de tipo físico. Dicha carga involucra múltiples tablas.
	 * @param dtoApartadoOf, dtoDocumentoOf, dtoDocClasifArea, dtoDocFolio, listaAnexos, listaRemitentes, listaDestinatarios, listaCcp
	 * @return void
	...
	/**
	 * Método encargado de recuperar una lista de remitentes externos con base en su nombre, dependencia, área y tipo de área.
	 * @param Integer idArea, Integer tipoArea, String nombreRemitente, String dependencia
	 * @return List<DTORemitentesExternosOfEntity>: Lista de los remitentes externos recuperados
	 * @author José Miguel Ortiz
	 * @since 09/04/2018
	 */
