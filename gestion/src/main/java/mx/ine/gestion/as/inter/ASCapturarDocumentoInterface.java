/**
 * @(#)ASCapturarDocumentoInterface.java 01/09/2017
 *
...
/**
 * Interface de la clase ASCapturarDocumentos, encargada de administrar los
 * objetos BO y DAO para la captura de documento ademas de generar funciones de
 * sistema relacionados a estos.
 * 
 * @author Sergio Ley Garcia
 * @since 01/09/2017
 */
public interface ASCapturarDocumentoInterface {
	...
	/**
	 * Método que obtiene las entidades capturadas en gestion 
	 * (NO TODAS, si no se ha hecho el organigrama del área relacionada a la entidad no la trae) 
	 * 
