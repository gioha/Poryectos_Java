/**
 * @(#)ASBandejaSeguimientoInterface.java 07/12/2017
 *
 ...
 *
 */
public interface ASBandejaSeguimientoInterface {
	 ...
	 * @since 20/12/2017
	 */
	public void notificacionBandejaEnviados(DTOEstructuraAreasEntity persona, DTOEnviadosDocumentosEntity enviado, boolean activar);
