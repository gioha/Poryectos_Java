/**
 * @(#)ASEstructuraInterface.java 21/08/2017
 *
 ...
 * @since 21/08/2017
 */
public interface ASEstructuraInterface {
	 ...
	 * @since 08/09/2017
	 */
	public List<DTOJerarquiaPersonasEntity> consultarEstructuraPorArea(Integer tipo, Integer idArea);
	...
	/**
	 * Método que guarda todos los elementos de la estructura.
	 * 
	 * 
	 * 
	 * @author Pável Alexei Martínez Regalado
