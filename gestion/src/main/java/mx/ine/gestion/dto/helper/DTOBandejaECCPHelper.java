/**
 * @(#)DTOBandejaECCPHelper.java 08/12/2017
 *
 ...
 *
 */
public class DTOBandejaECCPHelper implements Serializable {

	/**
	 * Objeto para la serialización de esta clase.
	 */
	private static final long serialVersionUID = 108419746617373875L;

	/**
	 * Atributo que sirve para guardar los filtros para realizar la consulta de
	 * la lista Lazy
	 */
	private List<DTOBandejaECCPEntity> ccp;
	...
	public DTOBandejaECCPHelper() {
		ccp = new ArrayList<DTOBandejaECCPEntity>();
	...
	public String obtenerFiltro(boolean conAlias) {
		...
		if(ccp != null){
			for (DTOBandejaECCPEntity elemento : ccp) {
	...
	public void ordenarPorNombre(boolean esAscendente) {
		camposOrdenamiento = new ArrayList<String>();
		listaOrden =  new ArrayList<String>();
		agregarCampoOrdenamiento("DOC.NUM_DOCUMENTO", esAscendente, esAscendente);
	}
	...
	/**
	 * @return valor de tipo List<DTOBandejaECCPEntity> que esta contenido en la
	 *         variable ccp
	 *
	 * @author Homero Fidel Villanueva
	 * @since 08/12/2017
	 */
	public List<DTOBandejaECCPEntity> getCcp() {
		return ccp;
	}
	 ...
	 * @since 08/12/2017
	 */
	public void setCcp(List<DTOBandejaECCPEntity> ccp) {
		this.ccp = ccp;
	}
