/**
 * @(#)DTOBandejaEAtencionID.java 27/11/2017
 *
 ...
 *
 */
public class DTOBandejaEAtencionID implements Serializable {

	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = 7841918623808529570L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOBandejaEAtencionID other = (DTOBandejaEAtencionID) obj;
		if (idDocumento == null) {
