/**
 * @(#)DTOHBandejaEAtecionId.java 10/01/2018
 *
 ...
 *
 */
public class DTOHBandejaEAtencionId implements Serializable {
	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = -4269864879380215181L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOHBandejaEAtencionId other = (DTOHBandejaEAtencionId) obj;
		if (idDocumento == null) {
