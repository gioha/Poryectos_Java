/**
 * @(#)DTOFirmaDocumentosID.java 29/08/2017
 *
 ...
 * tabla de FIRMA_DOCUMENTOS perteneciente al esquema de gestion4
 *
 * @author David Rodríguez Corral
 * @since 12/09/2017
 */
public class DTOFirmaDocumentosID implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOFirmaDocumentosID other = (DTOFirmaDocumentosID) obj;
		if (idDocumento == null) {
