/**
 * @(#)DTODocumentoFoliosID.java 10/12/2017
 *
 ...
 * tabla de DOCUMENTO_FOLIOS perteneciente al esquema de gestion4
 *
 * @author David Rodríguez Corral
 * @since 10/12/2017
 */
public class DTODocumentoFoliosID implements Serializable {

	/**
	 * Atributo para la serialización de la clase. 
	 */
	private static final long serialVersionUID = -7283040269574458347L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTODocumentoFoliosID other = (DTODocumentoFoliosID) obj;
