/**
 * @(#)DTOFiltrosCapturaDocumentoOfHelper.java 13/02/2018
 *
 ...
 *
 */
public class DTOFiltrosCapturaDocumentoOfHelper implements Serializable{

	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = -7539867085918700592L;
