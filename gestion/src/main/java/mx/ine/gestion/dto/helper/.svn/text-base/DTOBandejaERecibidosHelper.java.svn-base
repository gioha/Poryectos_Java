/**
 * @(#)DTOBandejaERecibidosHelper.java 05/12/2017
 *
 ...
 *
 */
public class DTOBandejaERecibidosHelper implements Serializable {

	/**
	 * Objeto para la serialización de esta clase.
	 */
	private static final long serialVersionUID = -8150445781885877427L;

	/**
	 * Atributo que sirve para guardar los filtros para realizar la consulta de
	 * la lista Lazy
	 */
	private List<DTOBandejaERecibidosEntity> recibidos;
	...
	public DTOBandejaERecibidosHelper() {
		recibidos = new ArrayList<DTOBandejaERecibidosEntity>();
	...
	public String obtenerFiltro(boolean conAlias) {
		...
		if(recibidos != null){
			for (DTOBandejaERecibidosEntity elemento : recibidos) {
	 ...
	 * @since 06/12/2017
	 */
	public List<DTOBandejaERecibidosEntity> getRecibidos() {
		return recibidos;
	}
	 ...
	 * @since 06/12/2017
	 */
	public void setRecibidos(List<DTOBandejaERecibidosEntity> recibidos) {
