/**
 * @(#)DTOBandejaERecibidosID.java 27/11/2017
 *
 ...
 *
 */
public class DTOBandejaERecibidosID implements Serializable {

	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = -711197332011746295L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOBandejaERecibidosID other = (DTOBandejaERecibidosID) obj;
		if (idDocumento == null) {
