/**
 * @(#)DTOBandejaEInfoID.java 27/11/2017
 *
 ...
 *
 */
public class DTOBandejaEInfoID implements Serializable {

	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = 5000813524146557401L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOBandejaEInfoID other = (DTOBandejaEInfoID) obj;
		if (idDocumento == null) {
