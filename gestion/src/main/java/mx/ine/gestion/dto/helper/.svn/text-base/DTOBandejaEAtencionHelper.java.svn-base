/**
 * @(#)DTOBandejaEAtencionHelper.java 18/01/2018
 *
 ...
 *
 */
public class DTOBandejaEAtencionHelper implements Serializable {

	/**
	 * Objeto para la serialización de esta clase.
	 */
	private static final long serialVersionUID = -415943473608067600L;

	/**
	 * Atributo que sirve para guardar los filtros para realizar la consulta de
	 * la lista Lazy
	 */
	private List<DTOBandejaEAtencionEntity> atencion;
	...
	public DTOBandejaEAtencionHelper() {
		atencion = new ArrayList<DTOBandejaEAtencionEntity>();
	...
	public String obtenerFiltro(boolean conAlias) {
		...
		if(atencion != null){
			for (DTOBandejaEAtencionEntity elemento : atencion) {
	...
	/**
	 * @return valor de tipo List<DTOBandejaEAtencionEntity> que esta contenido en la variable atencion
	 *
	 * @author Homero Fidel Villanueva
	 * @since 18/01/2018
	 */
	public List<DTOBandejaEAtencionEntity> getAtencion() {
		return atencion;
	}


	/**
	 * @param atencion : valor que se ingresa a la variable de tipo List<DTOBandejaEAtencionEntity>
	 *
	 * @author Homero Fidel Villanueva
	 * @since 18/01/2018
	 */
	public void setAtencion(List<DTOBandejaEAtencionEntity> atencion) {
