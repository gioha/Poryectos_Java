/**
 * @(#)DTOHBandejaEInfoHelper.java 19/01/2018
 *
 ...
 *
 */
public class DTOHBandejaEInfoHelper implements Serializable {


	/**
	 * Objeto para la serialización de esta clase.
	 */
	private static final long serialVersionUID = -5335808852613276592L;

	/**
	 * Atributo que sirve para guardar los filtros para realizar la consulta de
	 * la lista Lazy
	 */
	private List<DTOHBandejaEInfoEntity> info;
	...
	public DTOHBandejaEInfoHelper() {
		info = new ArrayList<DTOHBandejaEInfoEntity>();
	...
	public String obtenerFiltro(boolean conAlias) {
		...
		if(info != null){
			for (DTOHBandejaEInfoEntity elemento : info) {
	...
	/**
	 * @return valor de tipo List<DTOHBandejaEInfoEntity> que esta contenido en la variable info
	 *
	 * @author Homero Fidel Villanueva
	 * @since 19/01/2018
	 */
	public List<DTOHBandejaEInfoEntity> getInfo() {
		return info;
	}


	/**
	 * @param info : valor que se ingresa a la variable de tipo List<DTOHBandejaEInfoEntity>
	 *
	 * @author Homero Fidel Villanueva
	 * @since 19/01/2018
	 */
	public void setInfo(List<DTOHBandejaEInfoEntity> info) {
		this.info = info;
	}
}
