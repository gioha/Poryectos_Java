/**
 * @(#)DTOHBandejaEInfoID.java 10/01/2018
 *
 ...
 *
 */
public class DTOHBandejaEInfoID implements Serializable {

	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = -6718530746525160819L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOHBandejaEInfoID other = (DTOHBandejaEInfoID) obj;
		if (idDocumento == null) {
