/**
 * DTOBorradorDocumentosID.java 31/08/2017
 *
 ...
 *
 */
public class DTOBorradorDocumentosID implements Serializable {

	/**
	 * Atributo para la serialización de la clase.
	 */
	private static final long serialVersionUID = 8403620415425732688L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOBorradorDocumentosID other = (DTOBorradorDocumentosID) obj;
		if (idDocumento == null) {
