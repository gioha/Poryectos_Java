 ...
 * @since 29/11/2017
 */
public class MBBandejaHistorico implements Serializable {
	...
	@Autowired
	@Qualifier("bsdHBandejaERecibidos")
	private transient BSDHBandejaERecibidosInterface bsdBandejaERecibidosInterface;

	@Autowired
	@Qualifier("bsdHBandejaECCP")
	private transient BSDHBandejaECCPInterface bsdBandejaECCPInterface;
	
	@Autowired
	@Qualifier("bsdHBandejaEAtencion")
	private transient BSDHBandejaEAtencionInterface bsdBandejaEAtencionInterface;

	@Autowired
	@Qualifier("bsdHBandejaEInfo")
	private transient BSDHBandejaEInfoInterface bsdBandejaEInfoInterface;
	 ...
	 */
	private PaginarLazy<DTOHBandejaERecibidosEntity, DTOHBandejaERecibidosHelper> listaRecibidosLazy;

	/**
	 * Atributo que guarda la lista de los documentos recibidos
	 */
	private PaginarLazy<DTOHBandejaECCPEntity, DTOHBandejaECCPHelper> listaCCPLazy;
	
	/**
	 * Atributo que guarda la lista de los documentos recibidos
	 */
	private PaginarLazy<DTOHBandejaEAtencionEntity, DTOHBandejaEAtencionHelper> listaAtencionLazy;

	/**
	 * Atributo que guarda la lista de los documentos recibidos
	 */
	private PaginarLazy<DTOHBandejaEInfoEntity, DTOHBandejaEInfoHelper> listaInfoLazy;

	/**
	 * Atributo que guarda el documento recibido seleccionado
	 */
	private DTOHBandejaERecibidosEntity recibidoSeleccionado;

	/**
	 * Atributo que guarda el documento atencion seleccionado
	 */
	private DTOHBandejaEAtencionEntity atencionSeleccionado;

	/**
	 * Atributo que guarda el documento info seleccionado
	 */
	private DTOHBandejaEInfoEntity infoSeleccionado;

	/**
	 * Atributo que guarda el documento CCP seleccionado
	 */
	private DTOHBandejaECCPEntity ccpSeleccionado;
	 ...
	 */
	private DTOHBandejaERecibidosEntity filtroRecibido;

	/**
	 * 
	 */
	private DTOHBandejaERecibidosHelper filtrosRecibidosHelper;

	/**
	 * 
	 */
	private DTOHBandejaECCPEntity filtroCCP;

	/**
	 * 
	 */
	private DTOHBandejaECCPHelper filtrosCCPHelper;

	/**
	 * 
	 */
	private DTOHBandejaEAtencionEntity filtroAtencion;

	/**
	 * 
	 */
	private DTOHBandejaEAtencionHelper filtrosAtencionHelper;
	
	/**
	 * 
	 */
	private DTOHBandejaEInfoEntity filtroInfo;

	/**
	 * 
	 */
	private DTOHBandejaEInfoHelper filtrosInfoHelper;
		...
		if(boBandejaSeguimientoInterface.tieneRespuesta(helperResponder) ){
			if(indicaSeleccionado.equals(Utilidades.mensajeProperties("recibido_seleccionado")) && recibidoSeleccionado != null){
				...
				try {
					...
					RequestContext.getCurrentInstance().execute("PF('dialogResponderHistorico').hide()");
...
//				logger.error("", e);
		...
		RequestContext.getCurrentInstance().execute("PF('dialogReasignarHistorico').hide()");
...
//			atencionTurnadoServer = new Integer(atencionTurnado.intValue());
			RequestContext.getCurrentInstance().execute("PF('dialogReasignarHistorico').show()");
	...
	public void mostrarDialogAnexos() {
		RequestContext.getCurrentInstance().execute("PF('dialogVerAnexosHistorico').show()");
	}
	...
	public void ordenarRecibidosPorNombre(){
		...
		listaRecibidosLazy = new PaginarLazy<DTOHBandejaERecibidosEntity, DTOHBandejaERecibidosHelper>("bsdHBandejaERecibidos", filtrosRecibidosHelper);
	...
	public void ordenarAtencionPorNombre(){
		...
		listaAtencionLazy = new PaginarLazy<DTOHBandejaEAtencionEntity, DTOHBandejaEAtencionHelper>("bsdHBandejaEAtencion", filtrosAtencionHelper);
		ordenarPorNombre = !ordenarPorNombre;
	}
	...
	public void ordenarInfoPorNombre(){
		...
		listaInfoLazy= new PaginarLazy<DTOHBandejaEInfoEntity, DTOHBandejaEInfoHelper>("bsdHBandejaEInfo", filtrosInfoHelper);
		ordenarPorNombre = !ordenarPorNombre;
	}
	...
	public void ordenarCCPPorNombre(){
		...
		listaCCPLazy = new PaginarLazy<DTOHBandejaECCPEntity, DTOHBandejaECCPHelper>("bsdHBandejaECCP", filtrosCCPHelper);
		ordenarPorNombre = !ordenarPorNombre;
	}
...
//		ccpSeleccionado = null;
	...
	public void consultarRecibidosLazy() {
		filtroRecibido = new DTOHBandejaERecibidosEntity();
		filtrosRecibidosHelper = new DTOHBandejaERecibidosHelper();

		filtroRecibido.setIdPersona(usuario.getIdPersona());
		filtrosRecibidosHelper.getRecibidos().add(filtroRecibido);

		listaRecibidosLazy = new PaginarLazy<DTOHBandejaERecibidosEntity, DTOHBandejaERecibidosHelper>(
				"bsdHBandejaERecibidos", filtrosRecibidosHelper);
	}
	...
	public void consultarCCPLazy() {
		filtroCCP = new DTOHBandejaECCPEntity();
		filtrosCCPHelper = new DTOHBandejaECCPHelper();

		filtroCCP.setIdPersona(usuario.getIdPersona());
		filtrosCCPHelper.getCcp().add(filtroCCP);

		listaCCPLazy = new PaginarLazy<DTOHBandejaECCPEntity, DTOHBandejaECCPHelper>(
				"bsdHBandejaECCP", filtrosCCPHelper);
	}
	...
	public void consultarAtencionLazy() {
		filtroAtencion = new DTOHBandejaEAtencionEntity();
		filtrosAtencionHelper = new DTOHBandejaEAtencionHelper();
		...
		listaAtencionLazy = new PaginarLazy<DTOHBandejaEAtencionEntity, DTOHBandejaEAtencionHelper>(
				"bsdHBandejaEAtencion", filtrosAtencionHelper);
	}
	...
	public void consultarInfoLazy() {
		filtroInfo = new DTOHBandejaEInfoEntity();
		filtrosInfoHelper = new DTOHBandejaEInfoHelper();

		filtroInfo.setIdPersona(usuario.getIdPersona());
		filtrosInfoHelper.getInfo().add(filtroInfo);
		//ordenarRecibidosPorNombre();

		listaInfoLazy = new PaginarLazy<DTOHBandejaEInfoEntity, DTOHBandejaEInfoHelper>(
				"bsdHBandejaEInfo", filtrosInfoHelper);
	}
	...
	public void seleccionarFilaRecibido(SelectEvent event) {
		DTOHBandejaERecibidosEntity miRecibido = (DTOHBandejaERecibidosEntity) event.getObject();
		
		
		try {
			listaHistoricoTurnado = bsdBandejaEntradaInterface.obtenrHistoricoTurnado(miRecibido.getDocumento());
		} catch (Exception e) {
			log.error("<=================== Clase: "+this.getClass().getName()+" , Método: seleccionarFilaRecibido()");
			log.error("<=================== ocurrio un error al tratar de obtener la lista de personas remitentes de la BD para el documento seleccionado. ");
			log.error("<=================== USUARIO LOGUEADO: " + SecurityContextHolder.getContext().getAuthentication().getName());
			log.error("", e);
		}
	...
	public void seleccionarFilaCCP(SelectEvent event) {
		DTOHBandejaECCPEntity miCCP = (DTOHBandejaECCPEntity) event.getObject();
...
//		}
	...
	public void seleccionarFilaAtencion(SelectEvent event) {
		DTOHBandejaEAtencionEntity miAtencion = (DTOHBandejaEAtencionEntity) event.getObject();
...
//		}
	...
	public void seleccionarFilaInfo(SelectEvent event) {
		DTOHBandejaEInfoEntity miInfo = (DTOHBandejaEInfoEntity) event.getObject();
...
//		}
	 ...
	 * @since 12/12/2017
	 */
	public void seleccionarRecibido(DTOHBandejaERecibidosEntity recibido) {
	 ...
	 * @since 12/12/2017
	 */
	public void seleccionarCCP(DTOHBandejaECCPEntity ccp) {
	 ...
	 * @since 12/12/2017
	 */
	public void seleccionarAtencion(DTOHBandejaEAtencionEntity atencion) {
	 ...
	 * @since 12/12/2017
	 */
	public void seleccionarInfo(DTOHBandejaEInfoEntity info) {
	...
	/**
	 * @return valor de tipo PaginarLazy<DTOHBandejaERecibidosEntity,DTOHBandejaERecibidosHelper> que esta contenido en la variable listaRecibidosLazy
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public PaginarLazy<DTOHBandejaERecibidosEntity, DTOHBandejaERecibidosHelper> getListaRecibidosLazy() {
		return listaRecibidosLazy;
	}

	/**
	 * @param listaRecibidosLazy : valor que se ingresa a la variable de tipo PaginarLazy<DTOHBandejaERecibidosEntity,DTOHBandejaERecibidosHelper>
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setListaRecibidosLazy(
			PaginarLazy<DTOHBandejaERecibidosEntity, DTOHBandejaERecibidosHelper> listaRecibidosLazy) {
		this.listaRecibidosLazy = listaRecibidosLazy;
	}

	/**
	 * @return valor de tipo PaginarLazy<DTOHBandejaECCPEntity,DTOHBandejaECCPHelper> que esta contenido en la variable listaCCPLazy
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public PaginarLazy<DTOHBandejaECCPEntity, DTOHBandejaECCPHelper> getListaCCPLazy() {
		return listaCCPLazy;
	}

	/**
	 * @param listaCCPLazy : valor que se ingresa a la variable de tipo PaginarLazy<DTOHBandejaECCPEntity,DTOHBandejaECCPHelper>
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setListaCCPLazy(
			PaginarLazy<DTOHBandejaECCPEntity, DTOHBandejaECCPHelper> listaCCPLazy) {
		this.listaCCPLazy = listaCCPLazy;
	}

	/**
	 * @return valor de tipo DTOHBandejaERecibidosEntity que esta contenido en la variable recibidoSeleccionado
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaERecibidosEntity getRecibidoSeleccionado() {
		return recibidoSeleccionado;
	}

	/**
	 * @param recibidoSeleccionado : valor que se ingresa a la variable de tipo DTOHBandejaERecibidosEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setRecibidoSeleccionado(
			DTOHBandejaERecibidosEntity recibidoSeleccionado) {
		this.recibidoSeleccionado = recibidoSeleccionado;
	}

	/**
	 * @return valor de tipo DTOHBandejaEInfoEntity que esta contenido en la variable infoSeleccionado
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaEInfoEntity getInfoSeleccionado() {
		return infoSeleccionado;
	}

	/**
	 * @param infoSeleccionado : valor que se ingresa a la variable de tipo DTOHBandejaEInfoEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setInfoSeleccionado(DTOHBandejaEInfoEntity infoSeleccionado) {
		this.infoSeleccionado = infoSeleccionado;
	}

	/**
	 * @return valor de tipo DTOHBandejaECCPEntity que esta contenido en la variable ccpSeleccionado
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaECCPEntity getCcpSeleccionado() {
		return ccpSeleccionado;
	}

	/**
	 * @param ccpSeleccionado : valor que se ingresa a la variable de tipo DTOHBandejaECCPEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setCcpSeleccionado(DTOHBandejaECCPEntity ccpSeleccionado) {
		this.ccpSeleccionado = ccpSeleccionado;
	}

	/**
	 * @return valor de tipo DTOHBandejaERecibidosEntity que esta contenido en la variable filtroRecibido
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaERecibidosEntity getFiltroRecibido() {
		return filtroRecibido;
	}

	/**
	 * @param filtroRecibido : valor que se ingresa a la variable de tipo DTOHBandejaERecibidosEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setFiltroRecibido(DTOHBandejaERecibidosEntity filtroRecibido) {
		this.filtroRecibido = filtroRecibido;
	}

	/**
	 * @return valor de tipo DTOHBandejaERecibidosHelper que esta contenido en la variable filtrosRecibidosHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaERecibidosHelper getFiltrosRecibidosHelper() {
		return filtrosRecibidosHelper;
	}

	/**
	 * @param filtrosRecibidosHelper : valor que se ingresa a la variable de tipo DTOHBandejaERecibidosHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setFiltrosRecibidosHelper(
			DTOHBandejaERecibidosHelper filtrosRecibidosHelper) {
		this.filtrosRecibidosHelper = filtrosRecibidosHelper;
	}

	/**
	 * @return valor de tipo DTOHBandejaECCPEntity que esta contenido en la variable filtroCCP
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaECCPEntity getFiltroCCP() {
		return filtroCCP;
	}

	/**
	 * @param filtroCCP : valor que se ingresa a la variable de tipo DTOHBandejaECCPEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setFiltroCCP(DTOHBandejaECCPEntity filtroCCP) {
		this.filtroCCP = filtroCCP;
	}

	/**
	 * @return valor de tipo DTOHBandejaECCPHelper que esta contenido en la variable filtrosCCPHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaECCPHelper getFiltrosCCPHelper() {
		return filtrosCCPHelper;
	}

	/**
	 * @param filtrosCCPHelper : valor que se ingresa a la variable de tipo DTOHBandejaECCPHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setFiltrosCCPHelper(DTOHBandejaECCPHelper filtrosCCPHelper) {
		this.filtrosCCPHelper = filtrosCCPHelper;
	}

	/**
	 * @return valor de tipo DTOHBandejaEAtencionEntity que esta contenido en la variable atencionSeleccionado
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public DTOHBandejaEAtencionEntity getAtencionSeleccionado() {
		return atencionSeleccionado;
	}

	/**
	 * @param atencionSeleccionado : valor que se ingresa a la variable de tipo DTOHBandejaEAtencionEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 16/01/2018
	 */
	public void setAtencionSeleccionado(
			DTOHBandejaEAtencionEntity atencionSeleccionado) {
		this.atencionSeleccionado = atencionSeleccionado;
	}

	/**
	 * @return valor de tipo PaginarLazy<DTOHBandejaEAtencionEntity,DTOHBandejaEAtencionHelper> que esta contenido en la variable listaAtencionLazy
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public PaginarLazy<DTOHBandejaEAtencionEntity, DTOHBandejaEAtencionHelper> getListaAtencionLazy() {
		return listaAtencionLazy;
	}

	/**
	 * @param listaAtencionLazy : valor que se ingresa a la variable de tipo PaginarLazy<DTOHBandejaEAtencionEntity,DTOHBandejaEAtencionHelper>
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public void setListaAtencionLazy(
			PaginarLazy<DTOHBandejaEAtencionEntity, DTOHBandejaEAtencionHelper> listaAtencionLazy) {
		this.listaAtencionLazy = listaAtencionLazy;
	}

	/**
	 * @return valor de tipo PaginarLazy<DTOHBandejaEInfoEntity,DTOHBandejaEInfoHelper> que esta contenido en la variable listaInfoLazy
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public PaginarLazy<DTOHBandejaEInfoEntity, DTOHBandejaEInfoHelper> getListaInfoLazy() {
		return listaInfoLazy;
	}

	/**
	 * @param listaInfoLazy : valor que se ingresa a la variable de tipo PaginarLazy<DTOHBandejaEInfoEntity,DTOHBandejaEInfoHelper>
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public void setListaInfoLazy(
			PaginarLazy<DTOHBandejaEInfoEntity, DTOHBandejaEInfoHelper> listaInfoLazy) {
		this.listaInfoLazy = listaInfoLazy;
	}

	/**
	 * @return valor de tipo DTOHBandejaEAtencionEntity que esta contenido en la variable filtroAtencion
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public DTOHBandejaEAtencionEntity getFiltroAtencion() {
		return filtroAtencion;
	}

	/**
	 * @param filtroAtencion : valor que se ingresa a la variable de tipo DTOHBandejaEAtencionEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public void setFiltroAtencion(DTOHBandejaEAtencionEntity filtroAtencion) {
		this.filtroAtencion = filtroAtencion;
	}

	/**
	 * @return valor de tipo DTOHBandejaEAtencionHelper que esta contenido en la variable filtrosAtencionHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public DTOHBandejaEAtencionHelper getFiltrosAtencionHelper() {
		return filtrosAtencionHelper;
	}

	/**
	 * @param filtrosAtencionHelper : valor que se ingresa a la variable de tipo DTOHBandejaEAtencionHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public void setFiltrosAtencionHelper(
			DTOHBandejaEAtencionHelper filtrosAtencionHelper) {
		this.filtrosAtencionHelper = filtrosAtencionHelper;
	}

	/**
	 * @return valor de tipo DTOHBandejaEInfoEntity que esta contenido en la variable filtroInfo
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public DTOHBandejaEInfoEntity getFiltroInfo() {
		return filtroInfo;
	}

	/**
	 * @param filtroInfo : valor que se ingresa a la variable de tipo DTOHBandejaEInfoEntity
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public void setFiltroInfo(DTOHBandejaEInfoEntity filtroInfo) {
		this.filtroInfo = filtroInfo;
	}

	/**
	 * @return valor de tipo DTOHBandejaEInfoHelper que esta contenido en la variable filtrosInfoHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public DTOHBandejaEInfoHelper getFiltrosInfoHelper() {
		return filtrosInfoHelper;
	}

	/**
	 * @param filtrosInfoHelper : valor que se ingresa a la variable de tipo DTOHBandejaEInfoHelper
	 *
	 * @author Homero Fidel Villanueva
	 * @since 22/01/2018
	 */
	public void setFiltrosInfoHelper(DTOHBandejaEInfoHelper filtrosInfoHelper) {
