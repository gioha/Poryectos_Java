...
public class ServletCaptcha extends HttpServlet {
	...
	protected Integer			width				= 140;
	protected Integer			height				= 30;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		char[] letrasCaptcha = new char[] {'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'k', 'm', 'n', 'p', 'r', 'w', 'x', 'y', '2', '3', '4', '5', '6',
				'7', '8', '9'};
		// azul, negro, cafe, rojo, verde
		List<java.awt.Color> textColors = Arrays.asList(new Color(0, 0, 64), Color.black, new Color(66, 36, 0), new Color(64, 0, 0), new Color(0, 51,
				26));
		// Tipos de letra
		List<java.awt.Font> textFonts = Arrays.asList(new Font("Arial", Font.BOLD, 27), new Font("Arial", Font.ITALIC, 27), new Font("Helvetica",
				Font.ITALIC, 27), new Font("Arial", Font.PLAIN, 27), new Font("Helvetica", Font.PLAIN, 27));
